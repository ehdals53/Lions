...
public class SceneLoader_1 : MonoBehaviour
{
    ...
    {
        // 비동기방식으로 씬을 로드하고 로드가 완료될 때까지 대기함
    ...
    {
        // 라이트맵이 깨지는 것을 방지하지 위해 스테이지 씬을 활성화
        SceneManager.SetActiveScene(SceneManager.GetSceneByName("2Stage"));
        ...
        {
            // MoveTowoard 함수를 Lerp 함수와 동일한 함수로 알파값을 보간함
        ...
        SceneManager.UnloadSceneAsync("SceneLoader_1");
    }
}
