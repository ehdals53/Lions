...
public class Main_SceneLoader : MonoBehaviour
{
    ...
    {
        // 호출할 씬의 정보를 딕셔너리에 추가
        loadScenes.Add("MainSceneEnding", LoadSceneMode.Additive);
    }
    IEnumerator Start()
    {
        InitSceneInfo();
    ...
    IEnumerator Fade(float finalAlpha)
    {
        ...
        SceneManager.SetActiveScene(SceneManager.GetSceneByName("MainSceneEnding"));
        ...
        SceneManager.UnloadSceneAsync("Main_SceneLoader");
    }
}